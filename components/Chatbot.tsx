...
const getSystemInstruction = () => {
    const aboutMe = `Hello! I'm Mayank, a results-driven professional passionate about solving complex challenges with innovative, data-driven campaigns. With over four years of experience co-founding and growing a digital marketing agency, I've honed my skills in everything from strategic planning and team leadership to hands-on campaign execution and process optimization. I thrive on leveraging technology, especially AI and automation, to build groundbreaking solutions that drive ROI and pioneer brand growth. My work involves a deep dive into market research, audience persona development, and creating scalable systems that enhance efficiency and deliver high-impact results for clients across various industries. Whether it's launching a viral social media campaign or pioneering AI-driven marketing audits, my goal is always to deliver measurable success and contribute to building strong, resilient brands.`;
