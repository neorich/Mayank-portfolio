  ...
  return (
    <Section id="contact" title="Get In Touch">
      <div className="text-center max-w-2xl mx-auto">
        <h3 className="text-4xl md:text-5xl font-bold text-lightest-slate section-hidden" style={{ transitionDelay: '100ms' }}>Let's Connect</h3>
        <p className="text-slate my-6 text-lg section-hidden" style={{ transitionDelay: '200ms' }}>
        ...
        <div className="mt-10 flex flex-col sm:flex-row justify-center space-y-4 sm:space-y-0 sm:space-x-6 section-hidden" style={{ transitionDelay: '300ms' }}>
          <a
