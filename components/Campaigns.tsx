...
const TiltCard = ({ children, index, onClick, onKeyDown }: { children: React.ReactNode, index: number, onClick: () => void, onKeyDown: (e: React.KeyboardEvent<HTMLDivElement>) => void }) => {
