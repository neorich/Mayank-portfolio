    ...
    return (
        <Section id="cost-efficiency" title="Cost Efficiency vs Industry">
            <div className="max-w-5xl mx-auto">
                <p className="text-center text-slate mb-4 max-w-3xl mx-auto">
                ...
                <p className="text-center text-xs text-slate/70 mb-12 max-w-3xl mx-auto italic">
                ...
                <div className="mt-16">
                    <h3 className="text-xl md:text-2xl font-bold text-lightest-slate text-center mb-8">Key Takeaways: Massive Cost Savings</h3>
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                        {savings.map((item, index) => (
                            <div key={index} className="interactive-card p-6 rounded-lg text-center section-hidden" style={{ transitionDelay: `${index * 150}ms` }}>
